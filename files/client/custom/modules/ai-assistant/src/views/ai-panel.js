...
define('ai-assistant:views/ai-panel', ['view'], function (View) {
    ...
    var MODELS = [
        {value: 'gemini-3.5-flash:thinking-low', label: 'Gemini 3.5 Flash'},
        {value: 'gemini-3.5-flash:thinking-default', label: 'Gemini 3.5 Flash (thinking)'},
        {value: 'gemini-3.1-pro-preview', label: 'Gemini Pro'},
        {value: 'gemini-3.1-flash-lite-preview', label: 'Gemini Flash Lite'},
    ];

    var DEFAULT_MODEL = 'gemini-3.5-flash:thinking-low';
